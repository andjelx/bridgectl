...
class K8sSettings:
    # kube_config_path = Path(__file__).parent.parent / 'config' / 'kube_config.yaml'
...
class K8sClient:
    ...
    def create_bridge_pod(self, namespace, container_name, image_url, env_vars, labels):
