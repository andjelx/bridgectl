...
class K8sBridgeManager:
    ...
    def run_bridge_container_in_k8s(self, token_name, image_tag):
        req = self.req
        ...
        bridge_container_name = BridgeContainerBuilder.get_bridge_container_name(token.sitename, token.name)
        ...
        return self.k8s_client.create_bridge_pod(self.app.k8s_namespace, bridge_container_name, registry_image_url, env_vars, labels)
