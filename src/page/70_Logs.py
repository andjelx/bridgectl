...
def cached_k8s_log_file_names(_k8s_client, selected_pod_name, app: AppSettings):
    log_filenames = _k8s_client.list_pod_log_filenames(app.k8s_namespace, selected_pod_name)
...
PageUtil.set_page_config("Logs", "Analyze Bridge Logs")
