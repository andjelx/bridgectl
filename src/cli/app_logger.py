...
class AppLogger(LoggerInterface):
    ...
    def __init__(self, log_dir=""):
        ...
        if not os.path.exists(self.LOG_DIR):
            try:
                ...
                print(Fore.RED + f"Can't create {self.LOG_DIR}/ for logging - {e}")

        L = logging.getLogger('bridgectl')
        L.setLevel("INFO")

        self.current_log_file = f"{self.LOG_DIR}/bridgectl_{_date}.log"
    ...
    def _cleanup(self):
        ...
        log_files_list = glob.glob(f"{self.LOG_DIR}/bridgectl_*.log")
