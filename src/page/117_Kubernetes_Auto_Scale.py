...
from src.monitor.k8s_autosizing_task import K8S_TASK
...
def page_content():
    ...
    One PAT token will the used per bridge pod. These should be sufficient PAT tokens available in the token.yml.
...
PageUtil.set_page_config("AutoScale Bridge Pods", "AutoScale Bridge Pods", True)
page_content()
